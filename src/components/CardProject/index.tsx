...
export default function CardProject({name,description,id,language, homepage, index}: cardItem,) {
	...
	return (
		<div className={`w-[350px] m-auto mt-10 [&>div>button]:hover:bg-primary hover:bg-highlights [&>div>button]:hover:text-highlights bg-secondary overflow-hidden rounded-lg border-none [&>object]:hover:scale-110 duration-500 ${index > listLimit && "hidden"} h-[400px]`}>
			<object id={String(id)} className='w-[100%] h-[280px] duration-500' data={`https://raw.githubusercontent.com/EversonDias/${name}/main/readme/cardProject/main.png`} type='image/png'>
						<img
						id={String(id)}
